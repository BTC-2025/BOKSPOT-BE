...
var RazorpayProvider = function () {
    ...
    var RazorpayProvider = _classThis = /** @class */ (function () {
        function RazorpayProvider_1(configService) {
        ...
        RazorpayProvider_1.prototype.createOrder = function (amount, currency, bookingId) {
            return __awaiter(this, void 0, void 0, function () {
                var order;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.client.orders.create({
        ...
        RazorpayProvider_1.prototype.verifyWebhook = function (payload, signature) {
        ...
        RazorpayProvider_1.prototype.refund = function (paymentId, amount) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.client.payments.refund(paymentId, {
                            amount: Math.round(amount * 100),
                        })];
                });
            });
        };
        RazorpayProvider_1.prototype.verifyPaymentSignature = function (orderId, paymentId, signature) {
            var body = "".concat(orderId, "|").concat(paymentId);
            var expectedSignature = crypto
