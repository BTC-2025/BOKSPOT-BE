...
var NotificationsController = function () {
    var _classDecorators = [(0, swagger_1.ApiTags)('notifications'), (0, swagger_1.ApiBearerAuth)(), (0, common_1.Controller)('notifications')];
    ...
    var NotificationsController = _classThis = /** @class */ (function () {
        ...
        NotificationsController_1.prototype.findAll = function (user, isRead) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.notificationsService.findByUser(user.sub, isRead)];
                });
            });
        };
        NotificationsController_1.prototype.getUnreadCount = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                var count;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.notificationsService.getUnreadCount(user.sub)];
                        case 1:
                            count = _a.sent();
        ...
        NotificationsController_1.prototype.markAsRead = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.notificationsService.markAsRead(id)];
                });
            });
        };
        NotificationsController_1.prototype.markAllAsRead = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.notificationsService.markAllAsRead(user.sub)];
                });
            });
        };
    ...
    (function () {
        ...
        _findAll_decorators = [(0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Get user notifications' })];
        _getUnreadCount_decorators = [(0, common_1.Get)('unread-count'), (0, swagger_1.ApiOperation)({ summary: 'Get unread notification count' })];
        _markAsRead_decorators = [(0, common_1.Patch)(':id/read'), (0, swagger_1.ApiOperation)({ summary: 'Mark notification as read' })];
        _markAllAsRead_decorators = [(0, common_1.Patch)('read-all'), (0, swagger_1.ApiOperation)({ summary: 'Mark all notifications as read' })];
