...
var NotificationsService = function () {
    ...
    var NotificationsService = _classThis = /** @class */ (function () {
        ...
        NotificationsService_1.prototype.create = function (userId, type, title, message, data) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.notification.create({
                            data: { userId: userId, type: type, title: title, message: message, data: data },
                        })];
                });
            });
        };
        NotificationsService_1.prototype.findByUser = function (userId, isRead) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.notification.findMany({
                            where: __assign({ userId: userId }, (isRead !== undefined ? { isRead: isRead } : {})),
        ...
        NotificationsService_1.prototype.markAsRead = function (id) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
        ...
        NotificationsService_1.prototype.getUnreadCount = function (userId) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.prisma.notification.count({
                            where: { userId: userId, isRead: false },
                        })];
                });
            });
