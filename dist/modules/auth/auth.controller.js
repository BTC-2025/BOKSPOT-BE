...
var AuthController = function () {
    ...
    var AuthController = _classThis = /** @class */ (function () {
        ...
        AuthController_1.prototype.syncUser = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.syncUser(user.sub, user.email, user.name)];
                });
            });
        };
        AuthController_1.prototype.getMe = function (user) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, this.authService.getUserByAuthId(user.sub)];
                });
            });
        };
    ...
    (function () {
        ...
        _syncUser_decorators = [(0, common_1.Post)('sync'), (0, swagger_1.ApiBearerAuth)(), (0, swagger_1.ApiOperation)({ summary: 'Sync user from external auth token' })];
        _getMe_decorators = [(0, common_1.Get)('me'), (0, swagger_1.ApiBearerAuth)(), (0, swagger_1.ApiOperation)({ summary: 'Get current authenticated user' })];
        _healthCheck_decorators = [(0, common_1.Get)('health'), (0, public_decorator_1.Public)(), (0, swagger_1.ApiOperation)({ summary: 'Auth health check' })];
        __esDecorate(_classThis, null, _syncUser_decorators, { kind: "method", name: "syncUser", static: false, private: false, access: { has: function (obj) { return "syncUser" in obj; }, get: function (obj) { return obj.syncUser; } }, metadata: _metadata }, null, _instanceExtraInitializers);
