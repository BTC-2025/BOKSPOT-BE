"use strict";
// ============================================================
// Prisma Service — Database connection with graceful shutdown
// ============================================================
...
var PrismaService = function () {
    ...
    var PrismaService = _classThis = /** @class */ (function (_super) {
        ...
        /**
         * Soft-delete aware findMany extension
         */
        PrismaService_1.prototype.excludeDeleted = function (where) {
            return __assign(__assign({}, where), { deletedAt: null });
        };
