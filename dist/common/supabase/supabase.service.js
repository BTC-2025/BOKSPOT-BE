...
var SupabaseService = function () {
    ...
    var SupabaseService = _classThis = /** @class */ (function () {
        ...
        // ---- Storage ----
        SupabaseService_1.prototype.uploadFile = function (bucket, path, file, contentType) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, data, error, urlData;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.client.storage
                                .from(bucket)
        ...
        SupabaseService_1.prototype.deleteFile = function (bucket, path) {
            return __awaiter(this, void 0, void 0, function () {
                var error;
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, this.client.storage.from(bucket).remove([path])];
                        case 1:
                            error = (_a.sent()).error;
                            if (error)
                                throw error;
        ...
        SupabaseService_1.prototype.getPublicUrl = function (bucket, path) {
            var data = this.client.storage.from(bucket).getPublicUrl(path).data;
            return data.publicUrl;
        };
        // ---- Realtime channel helpers ----
        SupabaseService_1.prototype.subscribeToChanges = function (table, callback) {
            return this.client
                .channel("db-changes-".concat(table))
