...
var PaginationDto = function () {
    ...
    return _a = /** @class */ (function () {
            function PaginationDto() {
                ...
                this.sortOrder = (__runInitializers(this, _sortBy_extraInitializers), __runInitializers(this, _sortOrder_initializers, SortOrder.DESC));
                __runInitializers(this, _sortOrder_extraInitializers);
            }
            Object.defineProperty(PaginationDto.prototype, "skip", {
                get: function () {
                    var _b, _c;
                    return (((_b = this.page) !== null && _b !== void 0 ? _b : 1) - 1) * ((_c = this.limit) !== null && _c !== void 0 ? _c : 20);
                },
                enumerable: false,
                configurable: true
            });
            Object.defineProperty(PaginationDto.prototype, "take", {
                get: function () {
                    var _b;
                    return (_b = this.limit) !== null && _b !== void 0 ? _b : 20;
                },
                enumerable: false,
                configurable: true
            });
        ...
        (function () {
            ...
            _limit_decorators = [(0, swagger_1.ApiPropertyOptional)({ default: 20, minimum: 1, maximum: 100 }), (0, class_validator_1.IsOptional)(), (0, class_transformer_1.Type)(function () { return Number; }), (0, class_validator_1.IsInt)(), (0, class_validator_1.Min)(1), (0, class_validator_1.Max)(100)];
            _sortBy_decorators = [(0, swagger_1.ApiPropertyOptional)(), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsString)()];
            _sortOrder_decorators = [(0, swagger_1.ApiPropertyOptional)({ enum: SortOrder, default: SortOrder.DESC }), (0, class_validator_1.IsOptional)(), (0, class_validator_1.IsEnum)(SortOrder)];
...
function createPaginatedResponse(data, total, pagination) {
    var _a, _b;
    var page = (_a = pagination.page) !== null && _a !== void 0 ? _a : 1;
    var limit = (_b = pagination.limit) !== null && _b !== void 0 ? _b : 20;
