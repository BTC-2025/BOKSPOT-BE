...
function bootstrap() {
    return __awaiter(this, void 0, void 0, function () {
        var app, configService, port, corsOrigins, swaggerConfig, document;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    corsOrigins = configService.get('CORS_ORIGINS', 'http://localhost:4000,http://localhost:4001');
                    // Security
                    ...
                    // CORS
                    app.enableCors({
                        origin: corsOrigins.split(',').map(function (o) { return o.trim(); }),
                        credentials: true,
                ...
                case 2:
                    _a.sent();
                    console.log("\uD83D\uDE80 BETA Booking API running on http://localhost:".concat(port));
                    console.log("\uD83D\uDCDA Swagger docs at http://localhost:".concat(port, "/docs"));
                    return [2 /*return*/];
            }
        });
    });
